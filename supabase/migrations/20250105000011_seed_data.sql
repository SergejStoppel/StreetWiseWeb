...
BEGIN
    ...
    -- Color & Visual Design (10 rules) - Including axe-core compatible rule keys
    INSERT INTO rules (module_id, rule_key, name, description, default_severity) VALUES
    ...
    AND rule_key IN (
        ...
        'color-contrast', 'color-contrast-enhanced', 'link-in-text-block', 'ACC_CLR_01_TEXT_CONTRAST_RATIO', 'ACC_CLR_02_LARGE_TEXT_CONTRAST', 'ACC_CLR_04_COLOR_ONLY_MEANING',
    ...
    AND rule_key IN (
        ...
        'ACC_KBD_02_KEYBOARD_TRAP', 'color-contrast', 'link-in-text-block', 'ACC_CLR_01_TEXT_CONTRAST_RATIO', 'ACC_TBL_01_HEADER_MISSING'
    );
